...
const CONFIG_COMMANDS = new Set(['PAUSE', 'RESUME', 'RESUME_ALL_SYMBOLS', 'SET_SYMBOL_ENABLED', 'ADD_SYMBOL', 'REVIEW_SYMBOL', 'UPDATE_ENGINE_SETTINGS', 'UPDATE_RISK_SETTINGS', 'UPDATE_EXECUTION_SETTINGS'])
...
function commandLabel(name) {
  return {
    ...
    UPDATE_EXECUTION_SETTINGS: '更新执行参数',
  }[name] || name
}
